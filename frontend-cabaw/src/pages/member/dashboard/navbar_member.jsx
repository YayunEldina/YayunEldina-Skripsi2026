...
const NavbarMember = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-16 bg-white flex items-center justify-between px-8 z-50 shadow-sm border-b border-gray-100">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            {user.foto_profil ? (
              ...
              <div className="w-9 h-9 rounded-full bg-gray-200 flex items-center justify-center group-hover:bg-gray-300 transition">
                <svg
          ...
          <button
            ...
            className="w-9 h-9 rounded-full bg-white border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition ms-2"
          >
            <img
              src={LogoutIcon}
              alt="logout"
